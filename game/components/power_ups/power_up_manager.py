...
from game.components.power_ups.weapon1 import Weapon_1
...
class PowerUpManager:
    ...
    def update(self, game):
        ...
        for power_up in self.power_ups:
            ...
            if game.player.rect.colliderect(power_up):
                ...
                elif isinstance(power_up, Weapon_1):
                    game.player.set_image(SPACESHIP_WEAPON, (65, 75))
                #
    ...
    def generate_power_up(self):
        #
        power_up_type = random.choice([Shield, Weapon_1])
